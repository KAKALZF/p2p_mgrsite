...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#myModal [name=returnType]").html(data.returnTypeDisplay);
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3"><#assign
				currentMenu="bidrequest_publishaudit_list" /> <#include
				"../common/menu.ftl" /></div>
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post"
					action="/bidrequest_publishaudit_list">
							...
							<tr>
								...
								<td>
									<a href="javascript:void(-1);" class="auditClass"
										data-json='${data.jsonString}'>审核</a>
								</td>
							</tr>
							</#list>
						</tbody>
				...
				<div class="modal-content">
					<div class="modal-body">
						<form class="form-horizontal" id="editform" method="post"
							action="/bidrequest_publishaudit">
							<fieldset>
								<div id="legend" class="">
									<legend>发标前审核</legend>
								</div>
