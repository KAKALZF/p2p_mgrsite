...
<script type="text/javascript">
	  	$(function(){
			...
			if(parentId){
			$("a[data-dataid="+parentId+"]").parent().addClass("active");
			};
			...
			$(".edit_Btn").click(function(){
				...
				$("#editFormParentId").val(json.parenId);
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3"><#assign
				currentMenu="systemDictionaryItem" /> <#include "../common/menu.ftl"
				/></div>
			<div class="col-sm-9">
				...
				<div class="col-sm-12">
					...
					<form id="searchForm" class="form-inline" method="post"
						action="/systemDictionaryItem_list">
						<input type="hidden" id="currentPage" name="currentPage"
							value="${(qo.currentPage)!1}" />
							...
							<ul id="menu" class="list-group">
								<li class="list-group-item">
									<a href="#" data-toggle="collapse"
										data-target="#systemDictionary_group_detail">
										<span>数据字典分组</span>
									</a>
									...
									<ul class="in" id="systemDictionary_group_detail">
										...
										<li>
											<a class="group_item" data-dataid="${vo.id}"
												href="javascript:;">
												<span>${vo.title}</span>
											</a>
										</li>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" class="form-horizontal" method="post"
						action="systemDictionaryItem_update" style="margin: -3px 118px">
