...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3"><#assign currentMenu="rechargeOffline" />
				...
				<form id="searchForm" class="form-inline" method="post"
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="beginDate"
							id="beginDate" value="${(qo.beginDate?string('yyyy-MM-dd'))!''}" />
						到
					...
					<div class="form-group">
						<label>交易号</label>
						<input class="form-control" type="text" name="tradeCode"
							value="${(qo.tradeCode)!''}" />
					</div>
					<div class="form-group">
				...
				<div class="modal-content">
					<div class="modal-body">
						<form class="form-horizontal" id="editform" method="post"
							action="/rechargeOffline_audit.do">
							<fieldset>
								<div id="legend" class="">
