...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3"><#assign currentMenu="userFileAuth" />
					...
					<div class="modal-body">
						<form class="form-horizontal" id="editform" method="post"
							...
							<fieldset>
								...
								<input type="hidden" name="state" value="" id="editForm_state" />
								<div class="form-group">
