...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3"><#assign currentMenu="companyBank" />
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" class="form-horizontal" method="post"
						action="/companyBank_update" style="margin: -3px 118px">
						<input type="hidden" name="id" id="editForm_id" value="" />
						<div class="form-group">
							<label class="col-sm-3 control-label">选择银行</label>
							<div class="col-sm-6">
								<select id="bankType" class="form-control" autocomplete="off"
									name="bankName">
								</select>
							</div>
						</div>
